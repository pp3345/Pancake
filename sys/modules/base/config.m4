...
if test "$PHP_PANCAKEBASE" != "no"; then
  PHP_NEW_EXTENSION(PancakeBase, PancakeBase.c Pancake_coreFunctions.c Pancake_HTTPRequest.c Pancake_invalidHTTPRequestException.c Pancake_MIME.c, $ext_shared)
fi
